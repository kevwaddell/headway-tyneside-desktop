...
if (!is_admin()) {
	...
	function headway_scripts() {
		...
		wp_enqueue_style( 'external', get_template_directory_uri().'/assets/css/external.css', null, filemtime( get_template_directory().'/assets/css/external.css' ), 'screen' );
		wp_enqueue_style( 'styles', get_stylesheet_directory_uri().'/assets/css/styles.css', array('external'), filemtime( get_stylesheet_directory().'/assets/less/styles.less' ), 'screen' );
