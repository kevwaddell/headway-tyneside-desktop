...
if (!is_admin()) {
	...
	function headway_scripts() {
		...
		wp_enqueue_style( 'styles', get_stylesheet_directory_uri().'/assets/css/styles.css', array('external'), filemtime( get_stylesheet_directory().'/assets/css/styles.css' ), 'screen' );
